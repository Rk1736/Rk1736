...
fifa = pd.read_csv(r"C:\\Users\kunal\fifa data.csv")
...
fifa['nationality'].value_counts()[0:5]plt.figure(figsize=(5,5))

plt.figure(figsize=(5,5))
plt.bar(list(fifa['nationality'].value_counts()[0:5].keys()),list(fifa['nationality'].value_counts()[0:5]),color="r")
plt.show()
...
plt.bar(list(player_salary['short_name'])[0:5],list(player_salary['wage_eur'])[0:5],color=["blue","red","green","pink","orange"])
plt.show()
